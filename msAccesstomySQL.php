       ...
       // exit;
        ...
        if (count($data) > 0) {
            foreach ($data as $sl=> $item) {
                ...
                $checkingExist= "SELECT id FROM attendance_logs where card_no ='$cardNo' and  DATE(attendance_date)= '$checkingDt' and  is_process=0 ";
                ...
                if(!empty($existRow['id'])){
                    ...
                    $slave_sql = "INSERT INTO attendance_logs  (`card_no`, `nid_no`, `attendance_date`, `status`, `is_process`, `created_by_ip`,  `created_at`) VALUES( '${cardNo}', '${nidNo}', '${attendance_date_time}', 0, 0,'${created_by_ip}','${created_at}')";
